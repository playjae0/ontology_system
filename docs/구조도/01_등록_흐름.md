...
flowchart TD
  ...
  subgraph MG["machine gate — machine_gate()  (B50)"]
    ...
    HS["⚙ harness · kit/run_adapter.py<br/>① load (+G1B static vocab — stop here if red, B65) ② preflight ③ extract ④ schema (+G4C/G4D/G4E layer vocab, B65)<br/><b>⑤ pipeline.parse — full parser (B58 ②)</b><br/>LLM points injected as no-op"]
