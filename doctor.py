...
SUITES = [
    ...
    ("test_g6", 54, "플랫폼 창구 · 계기판 8종 · 지문 스캔 · B46 일괄 투입 · B58 형태 판정 기록"),
    ("test_g6_5", 76, "계약 미배선 24건 수리 · B58 재등록"),
    ("test_p1", 161, "파서 공용 코어 6종 · 구조 지도 · CSV reader · 역산 정합 · 파서 무판독 · ⑦ 폴백 · B58 산문 xlsx · 형태 판정 · B68 분할 기준"),
    ("test_p2", 52, "어댑터 생성 킷 6종 · 검수 뷰 렌더러 · 지도 필드 셋"),
    ("test_p3", 414, "구축 모드 등록 3단 · 2B 등록 개선 6건 · 등록개선 5건 · B58 관문 범위 · B59 관문 화면 · B60 관문 재실행·확정 요약 · B62 문답 로그 · B64 columns 해석·C38 잠금 · B65 어휘 대조·형태 판정 문의 · B66 포맷 무관 지문·미선택 네 갈래·CSV 전 구간 등가 · B67 열 판정 대장·이어하기 · B68 분할 줄"),
