...
SUITES = [
    ...
    ("test_g6", 86, "플랫폼 창구 · 계기판 8종 · 지문 스캔 · B46 일괄 투입 · B58 형태 판정 기록 · B69 다음 줄 명령 실재 · B70 내장은 mock일 때만·등록부 결손 · B72 인입 화면·큐 집계·--step"),
    ...
    ("test_p3", 431, "구축 모드 등록 3단 · 2B 등록 개선 6건 · 등록개선 5건 · B58 관문 범위 · B59 관문 화면 · B60 관문 재실행·확정 요약 · B62 문답 로그 · B64 columns 해석·C38 잠금 · B65 어휘 대조·형태 판정 문의 · B66 포맷 무관 지문·미선택 네 갈래·CSV 전 구간 등가 · B67 열 판정 대장·이어하기 · B68 분할 줄 · B69 좌표 태깅 화면 · B72 G39 산출 키"),
